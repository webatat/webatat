...
class WidgetModel(CachingModel):
  """
  """
  name = models.StringProperty()     		# name
  title = models.StringProperty()     		# Title
  wtype = models.StringProperty()               # widget type
  website = models.StringProperty()               # widget type
  content = properties.DictProperty()
  actor = models.StringProperty() 
  tags = models.StringListProperty()
  post_date = properties.DateTimeProperty(auto_now_add=True)
  key_template = '%(website)s/%(wtype)s/%(name)s'


class Template(CachingModel):
	website = models.StringProperty() 	
        name = models.StringProperty()  
	content = models.TextProperty() 
        key_template = '%(website)s/%(name)s' 

class Website(CachingModel):
  """
  """
  name = models.StringProperty()     		# Title
  title = models.StringProperty()     		# Title
  extra = properties.DictProperty()
  created_at = properties.DateTimeProperty(auto_now_add=True)
  status = models.IntegerProperty()
  key_template = '%(name)s'
...
class FlatPage(CachingModel):
  ...
  content = properties.DictProperty()
  actor = models.StringProperty() 
  createdDate = properties.DateTimeProperty(auto_now_add=True)
  ubdatedDate = properties.DateTimeProperty(auto_now_add=True)
  status = models.IntegerProperty()

  key_template = '%(website)s/flatpage/%(name)s'


class toto(models.Model):
	s = models.StringProperty() 
