...
urlpatterns += patterns('administration.views',
    (r'^_admin$', 'admin_admin'),
    (r'^_admin/add/widget/$', 'admin_add_widget'),   
    (r'^_admin/update/widget/(?P<website>\w+.\w+)/(?P<wtype>\w+)/(?P<name>\w+)$', 'admin_update_widget'),
    (r'^_admin/update/widget/', 'admin_update_widgets'), 
    (r'^_admin/delete/widget/(?P<website>\w+.\w+)/(?P<wtype>\w+)/(?P<name>\w+)$', 'admin_delete_widget'),
    (r'^_admin/add/flatpage/$', 'admin_add_flatpage'),
    (r'^_admin/update/flatpage/(?P<website>\w+.\w+)/(?P<name>\w+)$', 'admin_update_flatpage'),
    (r'^_admin/update/flatpage/', 'admin_update_flatpages'), 
    (r'^_admin/delete/flatpage/(?P<website>\w+.\w+)/(?P<name>\w+)$', 'admin_delete_flatpage'),
    (r'^_admin/add/template/$', 'admin_add_template'),
    (r'^_admin/update/template/(?P<website>\w+.\w+)/(?P<name>\w+)$', 'admin_update_template'),
    (r'^_admin/update/template/', 'admin_update_templates'), 
    (r'^_admin/delete/template/(?P<website>\w+.\w+)/(?P<name>\w+)$', 'admin_delete_template'),
)

#SPLASH
urlpatterns += patterns('splash.views',
    (r'^splash$', 'splash_splash'),
)
...
urlpatterns += patterns('front.views',
    (r'^$', 'front_front'),
    (r'^gallery/(?P<name>\w+)$', 'front_gallery'),
    (r'^article/(?P<title>\w+)$', 'front_article'),
    (r'^articles/$', 'front_articles'),
    (r'^sport/champion/(?P<champion>\w+)$', 'front_sport_champion'),
    (r'^sport/champion/(?P<champion>\w+)/match/(?P<iday>\w+)/(?P<imatch>\w+)$', 'front_sport_champion_match'),
)
...
urlpatterns += patterns('flat.views',
    ...
    (r'^p/(?P<website>\w+.\w+)/(?P<name>\w+)', 'flat_handler'),
    (r'^p/(?P<website>\w+.\w+)/(?P<name>\w+)/', 'flat_handler'),
)
